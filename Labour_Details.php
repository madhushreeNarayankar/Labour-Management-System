...
if(isset($_POST['submit']))
{
    ...
    $sql=mysqli_query($conn,"INSERT INTO Labour_Details VALUES('$v1','$v2','$v3','$v4','$v5','$v6','$v7','$v8')");
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form method="POST"> 
         <table>
           <h3>Add Labour</h3>
            <tr>
                <td>Enter Labour_ID</td>
            </tr>
            <tr>
                <td><input type="text" name="f1"/></td>
            </tr>
            <tr>
                <td>Enter Labour_Name</td>
            </tr>
             <tr>
                <td><input type="text" name="f2"/></td>
            </tr>
             <tr>
                <td>Enter Labour_Category</td>
            </tr>
             <tr>
                <td><input type="text" name="f3"/></td>
            </tr>
             <tr>
                <td>Enter Labour_Work_experience</td>
            </tr>
             <tr>
                <td><input type="text" name="f4"/></td>
            </tr>
             <tr>
                <td>Enter Labour_Fee_Structure</td>
            </tr>
             <tr>
                <td><input type="text" name="f5"/></td>
            </tr>
             <tr>
                <td>Enter Labour_Mobile_number</td>
            </tr>
             <tr>
                <td><input type="text" name="f6"/></td>
            </tr>
             <tr>
                <td>Enter Labour_City</td>
            </tr>
             <tr>
